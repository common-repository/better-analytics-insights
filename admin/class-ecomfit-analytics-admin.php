 ...
 * @subpackage Ecomfit_Analytics/admin
 */
...
class Ecomfit_Analytics_Admin
{
    ...
    public function __construct($plugin, $version, $web_id)
    {
        ...
        if ($this->woocommerce_active()) {
            ...
            add_action('admin_notices', function () {
                include(plugin_dir_path(__FILE__) . '/partials/ecomfit-analytics-admin-require-woocommerce.php');
            });
        }
    ...
    private function load_dependencies()
    {
        ...
        $api_url = ECOMFIT_ANALYTICS_API_URL;
    ...
    {
        wp_enqueue_style($this->plugin, plugin_dir_url(__FILE__) . 'css/ecomfit-analytics-admin.css', array(), $this->version, 'all');
    }
    ...
    {
        wp_enqueue_script($this->plugin, plugin_dir_url(__FILE__) . 'js/ecomfit-analytics-admin.js', array('jquery'), $this->version, false);
    }
    ...
    public function app_menu()
    {
        ...
        add_submenu_page(
            'ecomfit-app',
            'Ecomfit - Better Analytics & Insights',
            'Analytics',
            'manage_options',
            'ecomfit-analytics-app',
            array($this, 'app_page')
        );
    }
    ...
    public function app_page()
    {
        ...
        if ($isLogged) {
            include(plugin_dir_path(__FILE__) . '/partials/ecomfit-analytics-admin-dashboard.php');
        } else {
            ...
            include(plugin_dir_path(__FILE__) . '/partials/ecomfit-analytics-admin-login.php');
        }
    }
