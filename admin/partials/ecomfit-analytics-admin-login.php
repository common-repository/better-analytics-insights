<div class="ecomfit-wrapper ecomfit-wrapper-login">
    <div class="ecomfit-container">
        ...
        <div class="ecomfit-content ecomfit-text-center">
            ...
            <br><br>
            <button data-url="<?php echo ECOMFIT_ANALYTICS_APP_URL . '/platform/wordpress/login?domain=' . $_SERVER['SERVER_NAME'] . '&url=' . get_home_url() . '&webId=' . get_option('_ecomfit_web_id') . '&ecfApp=' . ECOMFIT_ANALYTICS_APP_TYPE; ?>"
                    class="ecomfit-btn ecomfit-btn-lg ecomfit-btn-primary ecomfit-analytics-btn-login">
                <?php
                echo get_option('_ecomfit_analytics_login') ? "Let Connect Again" : "Let Connect Now";
                ?>
            </button>
