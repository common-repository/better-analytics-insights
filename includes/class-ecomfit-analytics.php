...
class Ecomfit_Analytics
{
     ...
     * @since    1.0.0
     * @access   protected
     * @var      string $ecomfit_analytics The string used to uniquely identify this plugin.
     */
    protected $ecomfit_analytics;
    ...
    {
        if (defined('ECOMFIT_ANALYTICS_VERSION')) {
            $this->version = ECOMFIT_ANALYTICS_VERSION;
        } else {
            $this->version = '1.0.0';
        }
        $this->ecomfit_analytics = 'ecomfit-analytics';
    ...
    private function load_dependencies()
    {
         ...
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'admin/class-ecomfit-analytics-admin.php';

        /**
         * The class responsible for defining all actions that occur in the public-facing
         * side of the site.
         */
        require_once plugin_dir_path(dirname(__FILE__)) . 'public/class-ecomfit-analytics-public.php';
     ...
     *
     * Uses the Ecomfit_Analytics_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
    ...
    private function define_admin_hooks()
    {
        ...
        $plugin_admin = new Ecomfit_Analytics_Admin($this->get_ecomfit_analytics(), $this->get_version(), $this->get_web_id());
        ...
        $isLogged = get_option('_ecomfit_analytics_login');
    ...
    {
        $plugin_public = new Ecomfit_Analytics_Public($this->get_ecomfit_analytics(), $this->get_version(), $this->get_web_id());
     ...
     * @since     1.0.0
     */
    public function get_ecomfit_analytics()
    {
        return $this->ecomfit_analytics;
    }
