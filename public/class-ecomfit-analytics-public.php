 ...
 * @subpackage Ecomfit_Analytics/public
 */
 ...
 * @author     ecomfit
 */
class Ecomfit_Analytics_Public
{
    ...
    {
        wp_enqueue_style($this->plugin, plugin_dir_url(__FILE__) . 'css/ecomfit-analytics-public.css', array(), $this->version, 'all');
    }
    ...
    {
        wp_enqueue_script($this->plugin, plugin_dir_url(__FILE__) . 'js/ecomfit-analytics-public.js', array('jquery'), $this->version, false);
    }
    ...
    public function ecf_sdk_script()
    {
        echo '<script type="text/javascript">
				...
				})(window, document, "script", "ecomfit-sdk", "' . ECOMFIT_ANALYTICS_SDK_URL . '?v=' . ECOMFIT_ANALYTICS_SDK_VERSION . '&webId=' . $this->web_id . '");
			</script>';
    }
